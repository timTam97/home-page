...
export default function Home() {
    return (
        ...
        <div className="w-1/2 h-1/2 flex items-center justify-center text-center">
...
Both Nike(NKE.N), opens new tab and Lego told Reuters they have not authorized Herinckx’s imports of their goods to Russia.<br></br><br></br>
            ...
            <div className="h-screen flex items-center justify-center text-center">
                <article className="prose prose-stone dark:prose-invert lg:prose-xl px-6 py-10">
                    ...
                    <p>
                        ...
                        eating garlic bread with cheese to their children, with
                        the food earning such an iconic status in our culture
                        that kids will often dress up as warm, cheesy loaf for
                        Halloween. For years parents have espoused the health
                        benefits of eating garlic bread with cheese to their
                        children, with the food earning such an iconic status in
                        our culture that kids will often dress up as warm,
                        cheesy loaf for Halloween. For years parents have
                        espoused the health benefits of eating garlic bread with
                        cheese to their children, with the food earning such an
                        iconic status in our culture that kids will often dress
                        up as warm, cheesy loaf for Halloween. For years parents
                        have espoused the health benefits of eating garlic bread
                        with cheese to their children, with the food earning
                        such an iconic status in our culture that kids will
                        often dress up as warm, cheesy loaf for Halloween. For
                        years parents have espoused the health benefits of
                        eating garlic bread with cheese to their children, with
                        the food earning such an iconic status in our culture
                        that kids will often dress up as warm, cheesy loaf for
                        Halloween. For years parents have espoused the health
                    ...
                    <p>
                        ...
                        may be linked to a series of rabies cases springing up
                        around the country.
                    </p>
                </article>
            </div>
            ...
            {/* <div className="flex h-screen">
                <div className="m-auto">
                    <p className="break-normal">
                        Among the dozens of Nike-branded items the site offers<br/>
                        are the U.S. sportswear maker’s Phantom GT2 Elite soccer
                        boots, for 29,999 roubles, or around $330.
                    </p>
                </div>
            </div> */}
        </>
